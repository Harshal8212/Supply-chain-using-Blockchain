...
export default class Home extends React.Component {
    ...
    showVerifyProductPopUp(){
        this.setState({
            showVerifyProduct: true
        })
    }
                ...
                <div className="main-body" color="primary">
                    <Paper className="app" style={{ backgroundColor: "#92869f63", minHeight: 600 }} elevation={3}>
                        ...
                        <TabPanel value={this.state.tabValue} index={0} count={2}>
                                ...
                                : (
                                    ...
                                    <div>
                                        <Button 
                                            variant="contained" 
                                            color="secondary" 
                                            onClick={() => this.showVerifyProductPopUp()}>
                                        <AddIcon style={{ paddingRight: "4px", paddingTop: "1px" }} />Verify Product
                                        </Button>                     
                                        <br/>
                                        <br/>
                                    </div>
                            ...
                            {this.state.showVerifyProduct ? 
                            <ErrorBoundary 
                                hideLoaderScreen={() => this.hideLoader()} 
                                hideDialog={() => this.hideVerifyProductPopUp()}
                                setTransactionSuccess={(status) => this.setTransactionSuccess(status)}
                            >
                                <QRScanner 
                                    open={this.state.showVerifyProduct} 
                                    closePopup={() => this.hideVerifyProductPopUp()}
